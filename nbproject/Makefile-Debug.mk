...
# C Compiler Flags
CFLAGS=-mcpu=cortex-m3 -mthumb -mslow-flash-data -std=gnu11 -specs=nosys.specs -Os -g
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scsi2sd-v6-nb.elf.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scsi2sd-v6-nb.elf.exe: rtl/fpga_bitmap.o

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scsi2sd-v6-nb.elf.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/scsi2sd-v6-nb.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -Tsrc/firmware/link.ld
